...
export default function Dock( { bodies, bodyType }: { bodies: SolarSystemData | null, bodyType: "Stars" | "Planets" | "Dwarf Planets" | "Asteroids" | "Galaxies" }) {
    ...
    return (
        <div className="flex flex-col items-center justify-center align-middle gap-8">
            ...
            {bodyType === "Galaxies" && <ul className="flex flex-row gap-2">
